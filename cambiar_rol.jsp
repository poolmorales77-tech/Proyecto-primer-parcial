...
if (!adminRol.equals("admin")) {
...
} else if (nuevoRol == null || nuevoRol.isEmpty()) {
    mensaje = "Debes seleccionar un rol válido";
} else if (!nuevoRol.equals("admin") && !nuevoRol.equals("usuario")) {
    mensaje = "Rol inválido. Solo se permiten 'admin' o 'usuario'";
} else {
    Connection con = null;
    ...
    try {
        ...
        // Actualizar rol
        String sqlUpdate = "UPDATE usuarios SET rol=? WHERE id=?";
        ...
        if (resultado > 0) {
            exitoso = true;
            mensaje = "Rol actualizado correctamente para " + usuarioNombre + " a: " + nuevoRol.toUpperCase();
        } else {
